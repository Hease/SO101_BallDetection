...
MEASURABLE: list[tuple[str, str, str]] = [
    ...
    ("robot.grip_open", "그리퍼 열림(%)", "python -m sorting.teach grip"),
    ("robot.grip_closed", "그리퍼 닫힘(%)", "python -m sorting.teach grip"),
    ("robot.grip_empty_pct", "빈손 판정 기준(%)", "python -m sorting.teach grip"),
